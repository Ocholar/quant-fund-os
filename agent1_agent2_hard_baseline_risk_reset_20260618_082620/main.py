...
# ============================================================
# QFOS OUTLIER LOSS CAP ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â percentage based, equity-scaled
# Purpose:
...
def _qfos_expectancy_guard_with_cycle_log_inner(proposed_fills=None, context=None):
    ...
    try:
        ...
        # QFOS FALLBACK SCOUT QUALITY GUARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â inline pre-expectancy filter
        try:
...
def qfos_clean_runtime_state_if_db_baseline():
    try:
        ...
        if int(trades_n or 0) == 0 and int(open_n or 0) == 0:
            portfolio.cash = 100.0
            portfolio.positions.clear()
            entry_prices.clear()
...
def log_cycle_diagnostic(market_data=None, features=None, orders=None, portfolio=None, rejected=None, note=''):
    ...
    print('\n' + '=' * 72)
    print('QUANT FUND OS ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â CYCLE DIAGNOSTIC')
...
def _qfos_get_position_row(conn, symbol):
    ...
    # Fetch the row â€” handle both SQLAlchemy result (has .mappings()) and raw sqlite3 cursor
    row = None
    try:
...
def main():
    ...
    while True:
        try:
            ...
            # POLICY V2 FIXED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â persist normal feature map immediately after feature build
            try:
            ...
            if not ready:
                ...
                if fallback_features:
                    ...
                    # POLICY V2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â persist current feature map for trade classification
                    try:
            ...
            # QFOS ALLOCATOR OPPORTUNITY RESCUE ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â upstream rescue before fallback scout
            try:
            ...
            if not result.get('orders'):
                ...
                if scout_order:
                    ...
                    # POLICY V2 FIXED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â source-block weak fallback immediately after injection
                    try:
                    ...
                    # QFOS FALLBACK SCOUT SOURCE GUARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â directly after scout injection
                    try:
            ...
            # POLICY V2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â block weak fallback scout before ORDERS/EXPECTANCY
            try:
            ...
            # POLICY V2 FIXED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â block weak fallback orders in the real result['orders'] list
            try:
                if isinstance(result, dict) and isinstance(result.get('orders'), list):
                    result['orders'] = _qfos_v2_filter_fallback_orders(
                        result.get('orders', []),
...
# ============================================================
# QFOS SAFE WRAPPER PATCH ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ACTIVE OUTLIER LOSS + BIG LOSER COOLDOWN
...
# ============================================================
# QFOS BASKET LOSS GUARD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ACTIVE WRAPPER
# Purpose:
...
# ============================================================
# QFOS EMERGENCY BASKET WATCHDOG ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â DB-LEVEL PAPER EXIT
# Purpose:
...
# ============================================================
# QFOS ACTIVE POSITION WATCHDOG ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â DB-LEVEL EXIT PROTECTION
# Purpose:
...
# ============================================================
# QFOS PROFIT ENGINE V1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â TRADE CLASS + PARTIAL TP + RUNNERS
# Purpose:
...
# ============================================================
# QFOS POLICY V2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â CONSOLIDATED ENTRY CLASSIFICATION + RUNNER LOGIC
# Purpose:
