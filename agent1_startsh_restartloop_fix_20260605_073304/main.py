...
_qfos_db_os.environ["DATABASE_URL"] = "sqlite:///" + _qfos_db_path if _qfos_db_path.startswith("/") else "sqlite:///" + _qfos_db_os.path.abspath(_qfos_db_path)
...
def qfos_runtime_db_path():
    ...
    os.environ["DATABASE_URL"] = "sqlite:///" + p if p.startswith("/") else "sqlite:///" + os.path.abspath(p)
