...
pos_text = read("positive_positions_before_restart.txt")
trades_text = read("trades_count_before_restart.txt")
snap_text = read("snapshots_before_restart.txt")
archive_text = read("archive_before_restart.txt")
...
if "(0 rows)" not in pos_text:
    failures.append("positive positions existed before restart")
